...
type SelectionState = Record<GroupName, string[]>;
const emptySelections: SelectionState = { supportAreas: [], householdStage: [], preferredSupport: [], availability: [] };
  ...
  return (
    <main className="pledge-page">
      ...
      <section className="pledge-card">
        ...
        <form className="pledge-form" onSubmit={saveProfile}>
          {(Object.entries(groups) as [GroupName, (typeof groups)[GroupName]][]).map(([groupName, group]) => (
