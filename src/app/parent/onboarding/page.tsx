...
export default async function ParentOnboardingPage() {
  ...
  return <main className="pledge-page">
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(240px, 1fr))",gap:"1rem"}}>
      ...
      <div style={cardStyle}><p className="eyebrow">SUPPORT</p><h3>Request Support</h3><p>Create a structured request using broad family needs only. No child's name, school, exact age or personal story is needed.</p>{openRequests ? <p style={{fontWeight:700}}>Open requests: {openRequests}</p> : null}<Link href="/parent/support-request" className="button primary">Request Support</Link></div>
